                ...
                <ul class="flex flex-col gap-3">
                    ...
                    <li>
                        <form method="POST" action=" {{ route('logout') }} ">
                            @csrf
                            <button class="w-full p-[10px_16px] flex items-center gap-[14px] rounded-full h-11 transition-all duration-300 hover:bg-[#2B82FE]">
                                <div>
                ...
                @forelse($my_courses as $course)
                    <div class="list-items flex flex-nowrap justify-between pr-10">
                        ...
                        <div class="flex shrink-0 w-[120px] items-center">
                            ...
                            @else
                                <a href="#" class="w-full h-[41px] p-[10px_20px] bg-[#6436F1] rounded-full font-bold text-sm text-white transition-all duration-300 hover:shadow-[0_4px_15px_0_#6436F14D] text-center">Results</a>
                            @endif
                        </div>
                    </div>
                @empty
