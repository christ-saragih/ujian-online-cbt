...
<body class="font-poppins text-[#0A090B]">
    <section id="content" class="flex">
        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <form method="POST" action="{{ route('dashboard.course.student.store', $course) }}" id="add-question" class="mx-[70px] mt-[30px] flex flex-col gap-5">
                @csrf
                ...
                <button type="submit" class="w-[500px] h-[52px] p-[14px_20px] bg-[#6436F1] rounded-full font-bold text-white transition-all duration-300 hover:shadow-[0_4px_15px_0_#6436F14D] text-center">Add
                    Student</button>
            </form>
        </div>
    </section>
